...
public class BoxWorkManagementIgnoredHealthcheckNamesProviderTest {

    @InjectMocks
    private BoxWorkManagementIgnoredHealthcheckNamesProvider ignoredHealthcheckNamesProvider;
